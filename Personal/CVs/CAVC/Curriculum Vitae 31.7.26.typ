...
#let separator = line(start:(5em,0em),length:100%-10em, stroke:black.lighten(50%))
#show: resume.with(
  author: (
    firstname: "Tim",
    lastname: "Grace",
...
#separator
#resume-entry(
  title: "Senior Associate, Examiner, Trainer",
  location: "AQA",
  date: "2024 - Present"
)
#resume-item[
  - Resource creation for use across both AS and A Level Computer Science, including 'Getting Started teaching A Level Computer Science'
  - Leading training for teachers with a focus on marking, feedback and programming tasks.
  - Yearly marking of A Level Computer Science scripts to a tight deadline.
...
#resume-entry(
  ...
  location: "Ormiston Six Villages Academy",
  date: "2017 - 2019"
)
#resume-item[
- Completion of PGCE and NQT studies.
- Delivery of KS3 & 4 Mathematics including Foundation and Higher GCSE Mathematics.
- Developing department strategy for: engagement in Mathematics; Numeracy skills; effective tracking of student progress; stretching students beyond the specification.
]
\
= Skills
#resume-skill-grid(
